...
class Handler:
    ...
    def __init__(self, config: HandlerConfig, restart: bool=False, gui: bool=True):
        ...
        for server_config in self.__config.servers_config:
            self.__server_runners.append(ServerRunner(server_config, self.__stop_event, restart, self))
        ...
        self.__updater = Updater(self, self.__stop_event)

        self.__cli = Cli(self, self.__lang, gui)
